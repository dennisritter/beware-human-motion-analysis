...
left_elbow_angle = acm.calc_angles_elbow(seq, 1, 2, 0)
right_elbow_angle = acm.calc_angles_elbow(seq, 13, 14, 12)
left_knee_angle = acm.calc_angles_knee(seq, 7, 8, 6)
right_knee_angle = acm.calc_angles_knee(seq, 10, 11, 9)

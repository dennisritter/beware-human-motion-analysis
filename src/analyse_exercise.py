...
g_seq = mocap_poseprocessor.load(
    'data/sequences/191024_tracking/multi/overhead_press/user-2/191024__multi__overhead_press__user-2__0.json', "191024__multi__overhead_press__user-2__0.json")
# g_seq.visualise()
